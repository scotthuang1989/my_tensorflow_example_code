...
tf.app.flags.DEFINE_string('data_dir', '/tmp/mnist_distributed',
                           """Path to the CIFAR-10 data directory.""")
tf.app.flags.DEFINE_boolean('use_fp16', False,
                            """Train the model using fp16.""")
tf.app.flags.DEFINE_boolean('use_gpu',False,
							"""wether train with gpu""")
tf.app.flags.DEFINE_integer('num_epoch', 5,
                            """Number of batches to run.""")
tf.app.flags.DEFINE_string('logs_path', "/tmp/mnist/1",
